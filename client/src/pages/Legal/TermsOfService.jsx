  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <section className="mb-6">
        ...
        <p className="mb-2">
          Welcome to [Your Company Name]. These terms of service outline the rules and regulations for the use of our website and services.
        </p>
        <p className="mb-2">
          By accessing this website we assume you accept these terms of service. Do not continue to use [Your Website] if you do not agree to all of the terms and conditions stated on this page.
        </p>
      </section>
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-2">2. Cookies</h2>
        <p className="mb-2">
          We employ the use of cookies. By accessing [Your Website], you agreed to use cookies in agreement with the [Your Company Name]'s Privacy Policy.
        </p>
        <p className="mb-2">
      ...
      <section className="mb-6">
        ...
        <p className="mb-2">
          Unless otherwise stated, [Your Company Name] and/or its licensors own the intellectual property rights for all material on [Your Website]. All intellectual property rights are reserved. You may access this from [Your Website] for your own personal use subjected to restrictions set in these terms of service.
        </p>
        <p className="mb-2">
          You must not:
        </p>
      ...
      <section className="mb-6">
        ...
        <p className="mb-2">
          [Your Company Name] reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms of Service.
        </p>
      </section>
      <section className="mb-6">
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-2">6. Reservation of Rights</h2>
        <p className="mb-2">
          We reserve the right to request that you remove all links or any particular link to our Website. You approve to immediately remove all links to our Website upon request. We also reserve the right to amend these terms and conditions and its linking policy at any time. By continuously linking to our Website, you agree to be bound to and follow these linking terms and conditions.
        </p>
      </section>
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-2">7. Removal of links from our website</h2>
        <p className="mb-2">
